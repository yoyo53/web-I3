...
async function main() {
    ...
    const group1 = await prisma.groups.upsert({
        ...
        create: {
            ...
            name: "SE2",
            students: {
                connect: [{ studentID: student1.studentID }, { studentID: student2.studentID }],
            },
        },
    });
    ...
    const group2 = await prisma.groups.upsert({
        ...
        create: {
            ...
            name: "DT1",
            students: {
                connect: [{ studentID: student3.studentID }, { studentID: student4.studentID }],
            },
        },
    });
    ...
    const group3 = await prisma.groups.upsert({
        ...
        create: {
            ...
            name: "BI3",
            students: {
                connect: [{ studentID: student5.studentID }],
            },
        },
    });
