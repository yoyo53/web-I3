...
describe('admin routes', () => {
    describe('GET /admin/surveys', () => {
        ...
        it('should return 500 if there is an error', async () => {
            adminController.getAdminSurveys.mockImplementation((req, res) => res.status(500).send('Error while fetching surveys'));
    ...
    describe('DELETE /admin/deleteSurvey/:id', () => {
        it('should delete a survey by ID', async () => {
            adminController.deleteSurveyByID.mockImplementation((req, res) => res.status(200).json({ message: 'Survey deleted successfully' }));

            const response = await request(app).delete('/admin/deleteSurvey/1');
            expect(response.status).toBe(200);
        });
    ...
    describe('GET /admin/templates', () => {
        it('should return all survey templates', async () => {
            ...
            adminController.getSurveyTemplates.mockImplementation((req, res) => res.status(200).json(mockTemplates));
        ...
        it('should return 500 if there is an error', async () => {
            adminController.getSurveyTemplates.mockImplementation((req, res) => res.status(500).send('Error while fetching templates'));
    ...
    describe('POST /admin/templates/create', () => {
        it('should create a new survey template', async () => {
            ...
            const response = await request(app).post('/admin/templates/create').send({ name: 'Template 1', questions: [] });
            expect(response.status).toBe(200);
        });

        it('should return 500 if there is an error', async () => {
            adminController.createTemplate.mockImplementation((req, res) => res.status(500).send('Error while fetching templates'));
    ...
    describe('GET /admin/templates/:id', () => {
        ...
        it('should return 500 if there is an error', async () => {
            adminController.getTemplateByID.mockImplementation((req, res) => res.status(500).send('Error while fetching this template'));
    ...
    describe('GET /admin/modules', () => {
        ...
        it('should return 500 if there is an error', async () => {
            adminController.getAllModules.mockImplementation((req, res) => res.status(500).send('Error while fetching this module'));
    ...
    describe('POST /admin/createfromtemplate', () => {
        it('should create a survey from a template', async () => {
            ...
            const response = await request(app).post('/admin/createfromtemplate').send({ moduleID: 1, survey_templateID: 1 });
            expect(response.status).toBe(200);
        });
    ...
    describe('POST /admin/createfromnothing', () => {
        it('should create a survey from scratch', async () => {
            ...
            const response = await request(app).post('/admin/createfromnothing').send({ name: 'Survey 1', moduleID: 1, questions: [] });
            expect(response.status).toBe(200);
        });

        it('should return 400 if moduleID is missing', async () => {
            const response = await request(app).post('/admin/createfromnothing').send({ name: 'Survey 1', questions: [] });
            expect(response.status).toBe(400);
        });

        it('should return 400 if name is missing', async () => {
            const response = await request(app).post('/admin/createfromnothing').send({ moduleID: 1, questions: [] });
            expect(response.status).toBe(400);
        });

        it('should return 400 if questions are missing', async () => {
            const response = await request(app).post('/admin/createfromnothing').send({ name: 'Survey 1', moduleID: 1 });
            expect(response.status).toBe(400);
        });
    ...
    describe('DELETE /admin/template/:id', () => {
        it('should delete a template by ID', async () => {
            adminController.deleteTemplateByID.mockImplementation((req, res) => res.status(200).json({ message: 'Template deleted successfully' }));

            const response = await request(app).delete('/admin/template/1');
            expect(response.status).toBe(200);
        });
