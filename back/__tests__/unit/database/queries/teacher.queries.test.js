...
describe("Check exists teacher", () => {
    ...
    it("should throw a ConnectionError if a PrismaClientInitializationError occurs", async () => {
        ...
        await expect(teacherQueries.checkExistsTeacher(1)).rejects.toThrow(ConnectionError);
    });
    ...
    it("should throw a ValidationError if a PrismaClientValidationError occurs", async () => {
        ...
        await expect(teacherQueries.checkExistsTeacher(1)).rejects.toThrow();
    });
    ...
    it("should throw a ValidationError if an error code P2025 occurs", async () => {
        ...
        await expect(teacherQueries.checkExistsTeacher(1)).rejects.toThrow(ValidationError);
    });
    ...
    it("should throw a DatabaseError if a PrismaClientKnownRequestError occurs", async () => {
        ...
        await expect(teacherQueries.checkExistsTeacher(1)).rejects.toThrow(DatabaseError);
    });
    ...
    it("should throw the error if an unknown error occurs", async () => {
        ...
        await expect(teacherQueries.checkExistsTeacher(1)).rejects.toThrow(error);
    });
});
