...
describe('HomeView.vue', () => {
  ...
  test('renders the description paragraph', () => {
    const { getAllByText } = render(HomeView)
    getAllByText('TeachPoint is a platform that helps students grade their teachers easily and efficiently. With TeachPoint, students can grade their teachers in a few clicks.')
  })
